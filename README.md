...
Las herramientas que resuelven el código postal incluyen `postal_code_source` en su respuesta (`"argument"`, `"shared_default"`, `"env"` o `"builtin"`) para que sepas qué valor se usó. La fuente `"builtin"` indica que se está usando el código postal de fábrica `15001`.
